...
export function ScrollMorphVideo({
  ...
  return (
    <div
      ref={rootRef}
      className={`relative ${aspectClass} w-full overflow-hidden bg-transparent ${className}`}
    >
      <video
        ref={videoRef}
        className="relative z-[1] h-full w-full bg-transparent object-contain [content-visibility:auto]"
        muted
        playsInline
        preload="metadata"
